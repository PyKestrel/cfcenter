var GuacamoleModule = (() => {
  ...
  // node_modules/guacamole-common-js/dist/cjs/guacamole-common.js
  var require_guacamole_common = __commonJS({
    "node_modules/guacamole-common-js/dist/cjs/guacamole-common.js"(exports, module) {
      ...
      Guacamole.Display = function() {
        ...
        var asyncFlush = function asyncFlush2() {
          var continueFlush = function continueFlush2() {
            ...
            if (frames.length)
              inProgressFrame = window.requestAnimationFrame(continueFlush2);
          };
          if (!inProgressFrame)
  ...
  return require_guacamole_common();
})();
(function() { var G = GuacamoleModule; if (G && G.default) G = G.default; if (G && G.Guacamole) { window.Guacamole = G.Guacamole; } else { window.Guacamole = G; } })();
